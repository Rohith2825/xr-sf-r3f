...
export const Player = () => {
  ...
  const { 
    ...
    isInfoModalOpen , isDiscountModalOpen
  } = useComponentStore();
  ...
  useEffect(() => {
    const handleTouchStart = (e) => {
      ...
      if(isModalOpen || isCartOpen || isWishlistOpen || isInfoModalOpen || isDiscountModalOpen) return; // Return if any one of the components is open
  ...
  }, [camera, isPortrait, isTouchEnabled, isModalOpen, isCartOpen, isWishlistOpen, isInfoModalOpen,isDiscountModalOpen]);
